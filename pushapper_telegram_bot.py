...
def get_pep_talk(username, num_pushups, seed=None):
    ...
    s2 = [
        'Пока ты дрочил писю, ',
        'Пока ты стремительно наполнял желудок пищей, ',
        'Пока ты заедал стресс, ',
        'Пока ты жрал фастфуд, ',
        'Пока ты просиживал диван, ',
        'Пока ты ковырял в носу, ',
        'Пока ты залипал в Кваку, ',
        'Пока ты засыпал на митинге, ',
        'Пока ты прикидывался мучеником, ',
        'Пока ты сексуально деградировал, ',
